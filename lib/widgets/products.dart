...
class RceentProducts extends StatefulWidget{
  final String category;

  const RceentProducts({Key key, this.category}) : super(key: key);
  @override
  _RceentProductsState createState() {

    return _RceentProductsState();
  }
}

class _RceentProductsState extends State<RceentProducts>{
